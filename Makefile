...
HTTPS_GIT := https://github.com/mihongtech/iavl.git

PDFFLAGS := -pdf --nodefraction=0.1
CMDFLAGS := -ldflags -X TENDERMINT_IAVL_COLORS_ON=on 
LDFLAGS := -ldflags "-X github.com/mihongtech/iavl.Version=$(VERSION) -X github.com/mihongtech/iavl.Commit=$(COMMIT) -X github.com/mihongtech/iavl.Branch=$(BRANCH)"
